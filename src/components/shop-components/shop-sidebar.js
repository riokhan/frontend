...
//     return (
// 		<div className="col-lg-3 mobileviewfilter">
...
// 			<div className="widget ltn__menu-widget mobileviewfilter2" style={{ height: "126vh", overflowY: "auto" }}>
...
//         <ul>
//             <li><Link  style={{ fontSize: "10px", borderRadius: "20px" }}>Back Bay</Link></li>
//             <li><Link  style={{ fontSize: "10px", borderRadius: "20px" }}>Washington Square</Link></li>
//             <li><Link style={{ fontSize: "10px", borderRadius: "20px" }}>Fenway</Link></li>
//             <li><Link  style={{ fontSize: "10px", borderRadius: "20px" }}>Coolidge Corner</Link></li>
//             <li><Link  style={{ fontSize: "10px", borderRadius: "20px" }}>Kenmore</Link></li>
//             <li><Link  style={{ fontSize: "10px", borderRadius: "20px" }}>Brookline Village</Link></li>
//             <li><Link  style={{ fontSize: "10px", borderRadius: "20px" }}>Boston</Link></li>
//             <li><Link  style={{ fontSize: "10px", borderRadius: "20px" }}>Beacon Hill</Link></li>
//             <li><Link  style={{ fontSize: "10px", borderRadius: "20px" }}>Bay Village</Link></li>
//             <li><Link  style={{ fontSize: "10px", borderRadius: "20px" }}>Brookline</Link></li>
//             <li><Link  style={{ fontSize: "10px", borderRadius: "20px" }}>Union Square</Link></li>
//             <li><Link  style={{ fontSize: "10px", borderRadius: "20px" }}>Dorchester</Link></li>
//             <li><Link  style={{ fontSize: "10px", borderRadius: "20px" }}>Brighton</Link></li>
//             <li><Link  style={{ fontSize: "10px", borderRadius: "20px" }}>Allston</Link></li>
//             <li><Link  style={{ fontSize: "10px", borderRadius: "20px" }}>Longwood</Link></li>
//         </ul>
//     </div>
//     <hr />
...
const Sidebar = () => {
  ...
  const [activeBaths, setActiveBaths] = useState([]);

  const handleLinkClick = (category, value) => {
    switch (category) {
      case 'neighborhood':
        setActiveNeighborhoods(prevState =>
  ...
  const neighborhoods = [
    'Back Bay', 'Washington Square', 'Fenway', 'Coolidge Corner', 'Kenmore',
    'Brookline Village', 'Boston', 'Beacon Hill', 'Bay Village', 'Brookline',
    'Union Square', 'Dorchester', 'Brighton', 'Allston', 'Longwood'
  ];

  return (
    <div className="col-lg-3 mb-100 mobileviewfilter">
      <aside className="sidebar ltn__shop-sidebar">
        <div className="widget ltn__menu-widget mobileviewfilter2" style={{ height: "126vh", overflowY: "auto" }}>
          {/* Distance from BU Widget */}
          <div className="widget--- ltn__price-filter-widget">
            <h4 className="ltn__widget-title ltn__widget-title-border--- ltn__widget-title-border-2">Distance from BU</h4>
            <div className="price_filter">
              <div className="price_slider_amount">
              ...
              {neighborhoods.map(neighborhood => (
                <li key={neighborhood}>
                  <Link
                    ...
                    className={activeNeighborhoods.includes(neighborhood) ? 'active' : ''}
                    onClick={() => handleLinkClick('neighborhood', neighborhood)}
          ...
          <div className="ltn__tagcloud-widget go-top" style={{ marginTop: "40px" }}>
            <h4 className="ltn__widget-title ltn__widget-title-border-2">Beds</h4>
            <ul>
              {['Studio', '1', '2', '3', '4', '5', '6', '7'].map(bed => (
                <li key={bed}>
                  <Link
                    // to="/blog-grid"
                    className={activeBeds.includes(bed) ? 'active' : ''}
                    onClick={() => handleLinkClick('bed', bed)}
                    style={{ fontSize: "10px", borderRadius: "20px" }}
                  >
                    {bed}
                  </Link>
            ...
            <ul>
              {['1+', '1.5+', '2+', '2.5+', '3+'].map(bath => (
                <li key={bath}>
                  <Link
                    // to="/blog-grid"
                    className={activeBaths.includes(bath) ? 'active' : ''}
                    onClick={() => handleLinkClick('bath', bath)}
                    style={{ fontSize: "10px", borderRadius: "20px" }}
                  >
                    {bath}
                  </Link>
